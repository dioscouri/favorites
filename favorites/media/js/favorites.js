     ...
     * This should be renamed to favoritesResetFormFilters
     * 
     * @param form
     * @return
     */
    function favoritesResetFormFilters(form)
    {
	 ...
	 * @param {Object} task
	 */
	function favoritesGridOrdering( order, dir ) 
	{
	 ...
	 * @return
	 */
	function favoritesGridOrder(id, change) 
	{
		var form = document.adminForm;
     ...
     */
    function favoritesFormValidation( url, container, task, form ) 
    {
     ...
     * @return
     */
    function favoritesSubmitForm(task)
    {
	 ...
	 */
	function favoritesDisplayDiv (divname, spanname, showtext, hidetext) { 
	 ...
	 */
	function favoritesSwitchDisplayDiv( prefix, newSuffix )
	{
	...
	function favoritesShowHideDiv(divname)
	{
	 ...
	 */
	function favoritesDoTask( url, container, form, msg ) 
	{
		favoritesNewModal(msg);
		...
		{	
            ...
            var a=new Ajax(url,{
                ...
                onComplete: function(response){
                    ...
                    (function() { document.body.removeChild($('favoritesModal')); }).delay(500);
                    return true;
                }
            }).request();
		}
	 ...
	 * @param {String} msg message for the modal div (optional)
	 */
	function favoritesNewModal (msg)
	{
		...
		var src = 'media/com_favorites/images/ajax-loader.gif';
	 ...
	 * @return string
	 */
	function favoritesGetCheckedValue(radioObj) 
	{
	    if (!radioObj) { return ""; }
