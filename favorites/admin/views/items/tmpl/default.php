	...
	<table class="adminlist" style="clear: both;">
		<thead>
            <tr>
                ...
                <th style="width: 100px;">
                	<?php echo DSCGrid::sort( 'Scope', "tbl.scope_id", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 100px;">
            ...
            <tr class="filterline">
                ...
                <th>
                    ...
                    <?php echo FavoritesSelect::scope( @$state->filter_scope, 'filter_scope', $attribs, 'scope', true, 'Scope' ); ?>
                </th>
                <th>
